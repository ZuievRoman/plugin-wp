...
class SSLocalization
{
    ...
    public function localization(){
         ...
         * $domain - Уникальный идентификатор для получения строки перевода. (константа SS_PlUGIN_TEXTDOMAIN
         ...
         */
        load_plugin_textdomain(SS_PlUGIN_TEXTDOMAIN, false, SS_PlUGIN_DIR_LOCALIZATION);
    }
}